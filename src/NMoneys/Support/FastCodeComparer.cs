 ...
 */
internal class FastCodeComparer : IEqualityComparer<CurrencyIsoCode>
{
	...
	public static readonly IEqualityComparer<CurrencyIsoCode> Instance = new FastCodeComparer();
	...
	private static Func<CurrencyIsoCode, CurrencyIsoCode, bool> generateEquals()
	{
		...
		return Expression.Lambda<Func<CurrencyIsoCode, CurrencyIsoCode, bool>>(equalExpression, xParam, yParam).Compile();
	}
