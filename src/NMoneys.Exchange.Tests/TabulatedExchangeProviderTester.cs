...
namespace NMoneys.Exchange.Tests
{
	...
	{
		private TabulatedExchangeRateProvider _as20110519;
		...
		[TestCaseSource(typeof(ComplexProviderData), nameof(ComplexProviderData.fromEUR))]
		...
		[TestCaseSource(typeof(ComplexProviderData), nameof(ComplexProviderData.fromEURInverse))]
		...
		[TestCaseSource(typeof(ComplexProviderData), nameof(ComplexProviderData.toEUR))]
		...
		[TestCaseSource(typeof(ComplexProviderData), nameof(ComplexProviderData.toEURInverse))]
