...
public partial struct Money : IComparable, IComparable<Money>
{
	...
	public int CompareTo(object? obj)
	{
		...
		if (obj is not Money money) throw new ArgumentException($"Argument must be of type '{nameof(Money)}'.", nameof(obj));
	...
	/// <summary>
	/// Returns a value indicating whether the <see cref="Amount"/> is strictly greater than <see cref="decimal.Zero"/>.
	/// </summary>
	...
	/// <summary>
	/// Returns a value indicating whether the <see cref="Amount"/> is strictly equal to <see cref="decimal.Zero"/>.
	/// </summary>
