...
public class EvenAllocator
{
	...
	/// is allocate the maximum fair amount and leave the remaining amount for the caller to decide.</para>
	/// </remarks>
	...
	private static readonly Range<int> _validityRange = new(1.Close(), int.MaxValue.Close());
